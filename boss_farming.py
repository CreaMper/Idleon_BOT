...
def start(iterations):
    ...
    for i in range(iterations):
        ...
        # Check if entered successfully
        misc_wait_for_frame("amaroks_villa", "amarok_boss_head")

        time.sleep(2)  # loading offset
        mouse_click(amarok_click_kill, 0, 1)  # just kill him bro...

        misc_wait_for_frame("amarok_2", "amarok_dead")  # wait for Amarok to be dead
        ...
        if successful == 0:
            ...
            print("Drop Ratio :" + str(round(float(successful / i))) + "%")
